      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.table}>
              ...
              {items.map((item, bi) => (
                <View key={item.id} style={[styles.dataRow, bi % 2 === 1 && styles.dataRowAlt]}>
                  ...
                  {order.status === 'approved' && (
                    <>
                      <View style={[styles.valueCell, styles.approvedCell]}><Text style={[styles.valueText, styles.approvedText]}>{item.approved_1}</Text></View>
                      <View style={[styles.valueCell, styles.approvedCell]}><Text style={[styles.valueText, styles.approvedText]}>{item.approved_2}</Text></View>
                      <View style={[styles.valueCell, styles.approvedCell]}><Text style={[styles.valueText, styles.approvedText]}>{item.approved_3}</Text></View>
                      {request.category_type === 'beer' && (
                        <>
                          <View style={[styles.valueCell, styles.approvedCell]}><Text style={[styles.valueText, styles.approvedText]}>{item.approved_4}</Text></View>
                          <View style={[styles.valueCell, styles.approvedCell]}><Text style={[styles.valueText, styles.approvedText]}>{item.approved_5}</Text></View>
                        </>
                      )}
                    </>
                  )}
        ...
        {order.status === 'approved' && (
          <TouchableOpacity
            ...
            onPress={handleReceived} activeOpacity={received ? 1 : 0.8}
          >
            ...
            <View style={styles.receivedInfo}>
              <Text style={styles.receivedTitle}>{received ? 'Order Received' : 'Mark as Order Received'}</Text>
              <Text style={styles.receivedSub}>{received ? 'Confirmed — head office notified' : 'Tap to confirm when you receive the stock'}</Text>
            </View>
          </TouchableOpacity>
        )}
